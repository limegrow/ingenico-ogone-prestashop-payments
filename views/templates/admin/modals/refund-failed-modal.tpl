        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">
                    {l s='modal.refund_failed.title' mod='ingenico_epayments'}
                </h3>
            </div>
            <div class="modal-body">
                <ul>
                    <li>{l s='modal.refund_failed.label1' mod='ingenico_epayments'}</li>
                    <br>
                    <li>
                        {l s='modal.refund_failed.label2' mod='ingenico_epayments'}:<br>
                        <a href="mailto:{$support_email|escape:'htmlall':'UTF-8'}">
                            {$support_email|escape:'htmlall':'UTF-8'}
                        </a>
                    </li>
                    <br>
                    <li>
